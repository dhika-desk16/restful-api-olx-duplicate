...
class PostIklanPerlengkapanBayiDanAnakController extends Controller
{
    public $userEmail;
    public $kategori;
    public $randomString;
    ...
    public function postIklanPerlengkapanBayiDanAnak(Request $request, $kategori)
    {
        switch ($kategori) {
            case 'pakaian':
            case 'perlengkapanbayi':
            case 'perlengkapanibubayi':
            case 'boneka&mainananak':
            case 'bukuanakanak':
            case 'stroller':
            case 'lainlain':
                return $this->postIklanPerlengkapanBayiDanAnakByCategory($request, $kategori);
            default:
    ...
    private function postIklanPerlengkapanBayiDanAnakByCategory($request, $kategori)
    {
        return $this->postIklanPerlengkapanBayiDanAnakLogic($request, $kategori);
    }

    private function postIklanPerlengkapanBayiDanAnakLogic($request, $kategori)
    {
        ...
        if ($validator->fails()) {
            ...
            $iklan = IklanPerlengkapanBayiDanAnak::create([
    ...
    private function construct($tipeIklan)
    {
        $kategoriMapping = [
            'pakaian' => 'Pakaian',
            'perlengkapanbayi' => 'Perlengkapan Bayi',
            'perlengkapanibubayi' => 'Perlengkapan Ibu Bayi',
            'boneka&mainananak' => 'Boneka & Mainan Anak',
            'bukuanakanak' => 'Buku Anak',
            'stroller' => 'Stroller',
            'lainlain' => 'Lain-Lain',
        ];
        ...
        $tipeIklanArray = [
            'pakaian' => 'PBA-PAK',
            'perlengkapanbayi' => 'PBA-PRB',
            'perlengkapanibubayi' => 'PBA-PIB',
            'boneka&mainananak' => 'PBA-BON',
            'bukuanakanak' => 'PBA-BUK',
            'stroller' => 'PBA-STR',
            'lainlain' => 'PBA-LAI',
        ];
